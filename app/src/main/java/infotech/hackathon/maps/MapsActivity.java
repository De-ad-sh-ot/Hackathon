package infotech.hackathon.maps;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] mPlaceType = getResources().getStringArray(R.array.place_type);
        ...
        Spinner mSprPlaceType = (Spinner) findViewById(R.id.spr_place_type);
...
//        googlePlacesUrl.append("&key=" + "AIzaSyCDSN3cGLCVMhXKYiSRPKWlF4n0-K-_5_8");
